...
python3 test.py --type dynamic --model_path ./ckpts/ --image_path ./test_images/  --out_dir ./outputs/

python3 train.py --type dynamic --split 3Dobject --data_path ./datasets/kitti/object/training --model_name fine-turn

python3 test.py --type dynamic --model_path ./models/3Dobject/crossView/weights_300 --image_path ./test_images/  --out_dir ./outputs/
...
python3 test.py --type dynamic --model_path ./models/3Dobject/crossView/weights_280 --image_path ./test_images/  --out_dir ./outputs
...
python3 eval.py --type dynamic --split 3Dobject --pretrained_path ./ckpts --data_path ./fusion_dataset/town_2
...
./preprocessing/kitti/generate_supervision.py --base_path ./carla/label_2/ -
-seg_class vehicle --range 40 --occ_map_size 256